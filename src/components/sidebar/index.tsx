...
const Sidebar = ({farmerId,buyerId}:Props) => {
  ...
  const sidebarOptionBuyer = [
    ...
    { id: '3', name: 'Pre Sowing Contract', link: '/users', icon: <FileText size={20} /> },
    { id: '4', name: 'Post harvesting Contract', link: '/users', icon: <FileText size={20} /> },
    { id: '5', name: 'Settings', link: `/buyer/${buyerId}/settings`, icon: <Settings size={20} /> },
    { id: '6', name: 'Help', link: `/buyer/${buyerId}/help`, icon: <HelpCircle size={20} /> },
    { id: '7', name: 'Landing Page', link: `/buyer/${buyerId}`, icon: <HelpCircle size={20} /> },
  ]

...
export default function Home() {
  ...
  useEffect(() => {
    const translateContent = async () => {
      ...
      try {
        ...
        translatedContent.features = translatedContent.features.map(
          (feature, index) => ({
            ...feature,
  ...
  const checkLogin = async function (e: React.MouseEvent) {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 overflow-x-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center text-white">
        ...
        <div className="z-10 text-center px-4">
          ...
          <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mt-4 sm:mt-0">
            <Link href="/login" onClick={checkLogin}>
      ...
      <section className="py-12 sm:py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">
            {getContent("ourFeatures") as string}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {(getContent("features") as Feature[]).map(
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">
            {getContent("howItWorks") as string}
          </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">
                {getContent("weatherAlerts") as string}
              </h3>
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {(getContent("testimonials") as Testimonial[]).map(
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              <h3 className="text-xl font-bold mb-2">
                {getContent("stayUpdated") as string}
              </h3>
              <form className="flex">
                <input
                  type="email"

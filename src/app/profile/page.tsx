  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className=" max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
        <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Farmer Profile</h1>
        <div className="flex flex-col items-center mb-6">
          <img src={profile.profilePic} alt="Profile" className="w-32 h-32 rounded-full object-cover border-4 border-green-500" />
        </div>
        {isEditing ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600"><span className="font-medium">Phone:</span> {profile.phoneNumber}</p>
            <p className="text-gray-600"><span className="font-medium">Address:</span> {profile.address}</p>
            <p className="text-gray-600"><span className="font-medium">Adhaar:</span> {profile.adhaar}</p>
            <p className="text-gray-600"><span className="font-medium">Pan Card:</span> {profile.panC}</p>
            <button 
